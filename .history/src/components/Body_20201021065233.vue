  ...
  methods: {
    ...
    async discrepancyDetectAndFix(selClrm, desc) {
      ...
      for (let num = 0; num < this.classmembers.length; num++) {
        ...
        //処理前
        atDS= classmemDS[num][attnDest] == null || classmemDS[num][attnDest] == '' ? null : classmemDS[num][attnDest]; 
        atCL = this.classmembers[num][attnDest] == null || this.classmembers[num][attnDest] == '' ? null : this.classmembers[num][attnDest];
        atLS = objLS[num][attnDest];
        ...
        console.warn("一歩西に歩く" + num);
        atDS= classmemDS[num][attnDest]; 
        atCL = this.classmembers[num][attnDest] ;
        atLS = objLS[num][attnDest];
        resultStr += attnDest + '[' + atDS + ', ' + atCL + ', ' + atLS + ']/n';
      }
