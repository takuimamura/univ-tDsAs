              ...
              >
                <template slot-scope="props">
                  <b-table-column
                    ...
                    sticky
                  >
                    {{ getIfAttnThisWeekNotNull(selCrlm.dayofweek,props.row[selCrlm.attnthisweek],props.row._lastChangedAt)}}
                    ...
                    >
                      <b-icon
                        ...
                        size="is-medium"
                        :class="[
                       getIfAttnThisWeekNotNull(selCrlm.dayofweek,props.row[selCrlm.attnthisweek],props.row._lastChangedAt) ? 'is-synced' : '',
                                        ]"
                      />
                    </span>
                  </b-table-column>
