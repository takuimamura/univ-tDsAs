...
export default {
  ...
  methods: {
    ...
    async discrepancyDetectAndFix(selClrm, desc) {
      ...
      if (objLS !== null) {
        ...
        for (let num = 0; num < objCL.length; num++) {
          ...
          //処理前
          atDS= objDS[num][attnDest] == null || objDS[num][attnDest] == '' ? null : objDS[num][attnDest];
          atCL = objCL[num][attnDest] == null || objCL[num][attnDest] == '' ? null : objCL[num][attnDest];
          atLS = objLS[num][attnDest] == null || objLS[num][attnDest]=='' ? null : objLS[num][attnDest];
          ...
          if(atLS==null){
            ...
            if(atCL==null && atDS !==null){
              ...
              resultAddStr+=this.classmembers[num].studentcode+' '+attnDest+' DS -> class\n'
            }
          }else{
            if(atDS==null){
    ...
    updateDS(id, fname, fval, fnameHW, fvalHW){
