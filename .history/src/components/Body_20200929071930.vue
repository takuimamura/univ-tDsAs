                ...
                >
                  <div class="content column is-9">
                    ...
                    <p class="f23">
                      ...
                      <br />
                      <span class="is-text-5 has-text-weight-bold"
  ...
  methods: {
    ...
    async reflectClassSummary(classcode, dow) {
      ...
      const attnsum = ret.reduce((accumulator, current) => {
        return accumulator + (current[this.getThisWeekAttnJSON[dow]] !== null ? 1 : 0);
      }, 0);

      // 0:null >0:false ===length:true
      // tgt.attndone = ret.length === attnsum ? true : attnsum > 0 ? false : null;
      tgt.attndone = ret.length === attnsum ? true : attnsum > 0 ? false : null;
      tgt.syncdone = ret.length === syncedsum ? true : syncedsum > 0 ? false : null;
