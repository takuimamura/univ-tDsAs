  ...
  methods: {
    ...
    initallClasses() {
      this.yourClasses.forEach(m => {
        ...
        console.warn(
          m.dayofweek + this.getThisWeekAttnJSON[m.dayofweek] == null
            ? "null"
            : "not null"
        );
        console.warn(
          m.dayofweek + this.getThisWeekAttnJSON[m.dayofweek] == ""
            ? "blank"
            : "not blank"
        );
        console.warn(
          m.dayofweek + this.getThisWeekAttnJSON[m.dayofweek] == undefined
            ? "undefined"
            : "not undefined"
        );
        // クラスのタイムスタンプを反映
