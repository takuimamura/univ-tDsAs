...
export default {
  ...
  methods: {
    ...
    workdateValication() {
      //日付またぐとリロードする
      console.warn(this.dayACjsdddMMMD);
      console.warn(this.$dayjs().format("ddd, MMM D"));
      console.warn(this.dayACjsdddMMMD != this.$dayjs().format("ddd, MMM D"));
      if (
        ...
        console.warn("workdateValication .xxx");
