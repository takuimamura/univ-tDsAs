  ...
  methods: {
    ...
    checkAttnHWConsistency() {
      ...
      for (const rw of this.classmembers) {
        ...
        if (rw[this.getTodayJSON.attendance] == "not here" && rw[this.getTodayJSON.hwic] == false) {
          lg += "OK:" + str;
        } else {
          chk = true;
          lg += "NG:" + str;
      ...
      if (chk == true) {
        ...
        this.$buefy.dialog.alert({
          title: "Error",
          message: "Marking Absent and Homework Incompletion doesn't match.<br>Please check",
          type: "is-danger",
          hasIcon: true,
          icon: "times-circle",
          iconPack: "fa",
