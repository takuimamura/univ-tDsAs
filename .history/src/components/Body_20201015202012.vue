...
export default {
  ...
  methods: {
    ...
    async updateClrmAPI(id, fname, fval) {
      const upArr = {
        id: id
      };
      upArr[fname] = fval;
    ...
    // HW inomplete total
    getHWTotal(row) {
      return  "homeworkincomplete02" in row ? row.homeworkincomplete02 === false ? 1 : 0;
      // return row.homeworkincomplete02 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete03 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete04 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete05 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete06 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete07 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete08 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete09 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete10 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete11 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete12 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete13 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete14 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete15 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete16 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete17 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete18 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete19 === false
      //   ? 1
      //   : 0 + row.homeworkincomplete20 === false
      //   ? 1
      //   : 0;
    },
    checkIfHwic(val) {
  ...
  computed: {
    ...
    clrmShowCol() {
      ...
      for (var v = 0; v <= Number(finalWeek.lessonnum); v++) {
        switch (this.cRoom.showAttenHist) {
          case 0:
            if (this.cRoom.attnEditable) {
              arr.push(v <= Number(this.selCrlm.lssnthisweek) ? true : false); //授業週以前を表示
            } else {
              arr.push(v == Number(this.selCrlm.lssnthisweek) ? true : false); //授業週だけ表示
            }
            break;
          case 1:
            arr.push(v <= Number(this.selCrlm.lssnthisweek) ? true : false); //授業週以前を表示
    ...
    isClrmNeedAppSync: function() {
      return this.selCrlm.attndone
        ? this.selCrlm.syncdone
          ? false
          : true
        : false;
    }
