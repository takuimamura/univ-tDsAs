...
export default {
  ...
  methods: {
    ...
    devHelper() {
      ...
      if (this.authdetail.username === "t-imamura" || this.authdetail.username === "dummy") {
        this.cRoom.showDummy = true;
