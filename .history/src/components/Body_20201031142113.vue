...
export default {
  ...
  methods: {
    ...
    async idbStart() {
      ...
      if (
        await this.idbSet(this.idbCls, "init", this.getDateYYYYMMDDhHHMMSS())
      ) {
      ...
      const chkInit = await this.idbGet(this.idbCls, "init");
      if (chkInit) {
        console.warn("get ok:" + chkInit);
      } else {
        console.warn("get ng:" + chkInit);
      }
