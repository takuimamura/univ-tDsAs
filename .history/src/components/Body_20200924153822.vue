  ...
  <div id="app">
    ...
    <template v-if="this.authdetail.name !== undefined">
      ...
      <div v-if="getStartingUrl === 'localhost'">
        dyjstest {{ $dayjs(null)}} - {{ $dayjs(new Date()).format("H:mm") == "Invalid Date" ? true: false }}
        -----
        this.dataset.allClasses {{this.dataset.allClasses[0]}}
        <b-field>
...
export default {
  ...
  methods: {
    ...
    periodicValidation() {
      console.warn(
        "sett.Tab:" + this.sett.activeTab + "|" + this.sett.previousTab
      );
      this.sett.previousTab = this.sett.activeTab;
