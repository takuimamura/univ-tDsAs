...
export default {
  ...
  methods: {
    ...
    async checkAttnHWConsistency(classcode, dow) {
      ...
      // if(this.getThisWeekAttnJSON[dow]==""){
      console.warn("checkAttnHWConsistency");
    ...
    periodicValidation() {
      ...
      if (this.sett.activeTab !== 2) {
        ...
        if (this.isEnteredselCrlm) {
          //欠席と宿題の齟齬チェック
          console.warn("hw yaru"+this.checkAttnHWConsistency(this.selCrlm.id, this.selCrlm.dayofweek));
          if (await this.checkAttnHWConsistency(this.selCrlm.id, this.selCrlm.dayofweek) == true) {
            //警告
            console.warn("hw true");
