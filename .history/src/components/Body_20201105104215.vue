          ...
          <div class="columns">
            ...
            <div class="column is-four-fifths">
              ...
              <template v-if="sett.devshow">
                ...
                getLatestJSON2: {{ getLatestJSON2.Mon.lessonmum }} - {{ getLatestJSON2.Tue.lessonmum }} - {{ getLatestJSON2.Wed.lessonmum }} - {{ getLatestJSON2.Thu.lessonmum }} -{{ getLatestJSON2.Fri.lessonmum }}
                <br />dayChainJSON:
