    ...
    Hub.listen("datastore", async hubData => {
      ...
      switch (event) {
        case "networkStatus":
          ...
          console.log(`HUBlog User has a network connection? ${data.active}`);
          if (data.active === false) {
            this.app.network = false;
          }
          break;
        case "syncQueriesReady":
          console.log("HUBlog syncQueriesReady");
        ...
        //   break;
        case "modelSynced":
          console.log(`HUBlog modelSynced:${JSON.stringify(data)}`);
          break;
        case "outboxStatus":
          // log(`HUB outboxStatus:${JSON.stringify(data)}`);
          console.log(`HUBlog outboxStatus:${JSON.stringify(data)}`);
          this.app.syncing = data.isEmpty;
          break;
        case "ready":
          console.log("HUBlog ready");
          this.app.ready = true;
          break;
      }
    });
