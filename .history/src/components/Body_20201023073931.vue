...
export default {
  ...
  methods: {
    ...
    selectClassroom(arr) {
      ...
      //セット
      this.selClrm = arr;
      this.classmembers = this.getClassmembers(this.selClrm.id, true);
      //ここまで編集可能
    ...
    getClassmembers(classcode, hwPadding = false) {
      ...
      if (hwPadding == true) {
        ret.forEach(
          (m) =>
            (m.homeworkincomplete04 =
              m.homeworkincomplete04 == null ? "uu" : m.homeworkincomplete04)
        );
        console.warn("HWpadding");
      }
      console.warn(ret);
      return ret;
      //HWのnullをTrueにかえたい
