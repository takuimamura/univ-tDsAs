<template>
  <div id="app">
    <div v-if="getStartingUrl === 'localhost'">
      <b-button @click="FIREcreateMisc(sett.dummy)">FIREcreateMisc</b-button>
      <b-button @click="FIREcreateMiscCo(sett.dummy)">FIREcreateMiscCo</b-button>
      <b-button @click="FIREQueryMiscCo(sett.dummy)">FIREQueryMiscCo</b-button>
