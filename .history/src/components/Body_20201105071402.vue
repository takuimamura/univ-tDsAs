...
export default {
  ...
  methods: {
    ...
    async listMngsAPI() {
      console.warn(this.authdetail.username);
      try {
    ...
    async manageMng() {
      ...
      // const obj = this.dataAPI.Mngs.filter(
      //   n => (n.type = this.authdetail.username)
      // );
      const trigger = this.dataAPI.Mngs.trigger;
      const detail = this.dataAPI.Mngs.detail;

      console.warn(trigger, detail, this.dataAPI.Mngs);
