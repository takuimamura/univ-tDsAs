      ...
      <template v-if="sett.devarea">
        ...
        <div v-if="sett.devscreen">
          ...
          <b-field>
            ...
            >Tgt {{ getDateMDddd(sett.ddate) }} change</b-button>
            <b-numberinput
            ...
            <b-button
              size="is-small"
              @click="setcurrentAcDate()"
            >AC{{ getDateMDddd(sett.ddate) }} change</b-button>
          ...
          <b-switch size="is-small" v-model="sett.devsummary">devshow : {{ sett.devshow }}</b-switch>
          idle:{{ IdleVueStatus }}
...
export default {
  ...
  methods: {
    ...
    datasetManage() {
      console.warn(this.sett.priorityLS);
    ...
    stopDScheck: function() {
      this.writeNoteLS(
        "stopDScheck:this.dataDS.queryChk=" + this.dataDS.queryChk
      );
      if (this.dataDS.queryChk) {
        "stopDScheck:this.dataDS.queryChk=" +
          this.dataDS.queryChk +
          " clearInterval";
