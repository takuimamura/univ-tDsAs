                                        ...
                                        >
                                          ...
                                          <span v-show="indiRow[k.evl] !== -1">
                                            <star-rating
                                              ...
                                              @current-rating="setEvalUpTarget(
                                                  $event,
                                                  indiRow,
                                                  k.evl,
                                                  cRoom.indiNo)"
...
export default {
  ...
  async beforeCreate() {
    console.warn("beforecreate" + JSON.stringify(this.authdetail));
    Hub.listen('auth', (data) => {
      ...
      switch (event) {
        case 'signIn':
          console.warn('signing in...', event, data);
          break;
        case 'signOut':
  ...
  async created() {
    ...
    console.warn("this.authdetail" + JSON.stringify(this.authdetail));
    this.sendUserAgent();
    //// ClrmはDataStoreで
    await this.fetchClrms();
    //// InstはAPIで
