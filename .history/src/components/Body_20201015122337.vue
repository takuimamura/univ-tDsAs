                ...
                <template slot-scope="props">
                  ...
                  >
                    <template slot="header">
                      ...
                      <!-- <template v-if="this.cRoom.attnEditable"> -->
                      <!-- <b-radio-button
                        size="is-medium"
                        v-show="this.cRoom.attnEditable"
                        v-model="cRoom.attnEditTgtWeek"
                        :native-value="aa.at"
...
export default {
  ...
  methods: {
    ...
    selectClassroom(arr) {
      ...
      //編集対象週ボタンの初期値
      this.cRoom.attnEditTgtWeek = this.selCrlm.editableUntil;
