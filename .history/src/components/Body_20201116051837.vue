          ...
          for (let v of clnum[x.classcode]) {
            if (x[v] !== ax[v]) {
              ...
              if (x[v] !== null && x[v] !== "") {
                //相違あり またはAPIがブランク
                //記録するにとどめる
                console.warn("diff", ax.index, ax.studentname, v, x[v], ax[v]);
              } else {
                //ブランク
                if (ax[v] !== null && ax[v] !== "") {
                  // idbブランク apiあり
                  console.warn("x-o", ax.index, ax.studentname, v, x[v], ax[v]);
                } else {
                  //両方ブランク
                  console.warn("x-x", ax.index, ax.studentname, v, x[v], ax[v]);
                }
              }
            } else {
