    ...
    <template v-if="this.authdetail.name !== undefined">
      ...
      <div v-if="getStartingUrl === 'localhost'">
        ...
        <template v-if="sett.devcheck">
          <b-icon pack="fas" icon="star" size="is-large"></b-icon>

          <b-icon pack="fas" icon="grin" size="is-large"></b-icon>
          <b-icon pack="fas" icon="smile" size="is-medium"></b-icon>
          <b-icon pack="fas" icon="grin-stars" size="is-large"></b-icon>
          <b-icon pack="fas" icon="star-half-alt" size="is-large"></b-icon>
        </template>
        x
      </div>
