<template>
  <div id="app">
    <div v-if="getStartingUrl === 'localhost'">
      <b-field>
        <b-input v-model="ds.type" placeholder="type.."></b-input>
        <b-input v-model="ds.name" placeholder="name.."></b-input>
        <b-input v-model="ds.detail" placeholder="detail"></b-input>
        <b-button @click="createMisc">Create Misc</b-button>
        <b-button @click="getMiscId">get Misc id</b-button>
        misc ret: {{ds.misc.return}}
      </b-field>
  ...
  data() {
    return {
      ...
      ds: {
        ...
        clrmDl: null,
        clrmItems: null,
        misc: { id: null, type: null, name: null, detail: null, return: null }
      },
      setval1: null,
      setval2: null,
