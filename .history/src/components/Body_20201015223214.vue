                        ...
                        <div class="tile is-child">
                          <b-field>
                            ...
                            <span class="hwtotal" v-show="attnHWEditTgt !== 'homeworkincomplete01'">
                              ...
                              {{getHWr(props.row.homeworkincomplete02) +
                              getHWr(props.row.homeworkincomplete03) +
                              getHWr(props.row.homeworkincomplete04) +
                              getHWr(props.row.homeworkincomplete05)}}
                            </span>
  ...
  methods: {
    ...
    getHWTotal(row) {
      const chk = function(r, str) {
        if (r && r[str]) {
          return r[str] === null ? 0 : r[str] === false ? 1 : 0;
        } else {
          return 0;
        }
      };
